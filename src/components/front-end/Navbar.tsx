        ...
        <div className="flex justify-between items-center">
          ...
          <div className="text-black flex justify-center ml-16">
            ...
            <DropdownMenu
              ...
              menuItems={[
                "Lord Ganesh Grace",
                "Lord Shiva Reverence",
                "Lord Vishnu's Vaikuntha Veneration",
                "Goddess Durga Shakti Sadhana",
                "Lord Bhairav Bhakti",
                "Goddess Bhairavi Blessings",
                "Goddess Kali",
                "Goddess Dhanalaxmi Light",
                "Goddess Saraswati Virtue",
                "Lord Hanuman Harmony",
                "Lord Vithlal Prayers",
                "Lord Ayappa Abode",
                "Lord Murugan Might",
                "Surya Dev Serene",
                "Shani Dev Serenity",
            ...
            <DropdownMenu
              ...
              menuItems={[
                ...
                "Bhagvad Gita Treasury",
                "Ramayana Recollections",
            ...
            <DropdownMenu
              ...
              menuItems={[
                "Diwali Delights: Festival of Lights Celebrations",
                "Holi Happiness: Festival of Colors Essentials",
                "Navratri Necessities: Nine Nights of Worship",
                "Durga Puja Pandal: Celebrating the Goddess",
                "Janmashtami Joy: Lord Krishna's Birthday Celebrations",
                "Ganesh Chaturthi Gear: Welcoming the Elephant God",
                "Ram Navami Revelry: Lord Rama's Birth Celebrations",
                "Makar Sankranti Must-Haves: Harvest Festival Essentials",
                "Pongal Preparations: Tamil Harvest Festival Supplies",
                "Onam Offerings: Kerala Harvest Festival Traditions",
                "Baisakhi Bazaar: Sikh New Year Celebrations",
                "Guru Purnima Goods: Honoring Spiritual Gurus",
                "Maha Shivaratri Supplies: Night of Lord Shiva Worship",
                "Vasant Panchami Picks: Saraswati Puja Essentials",
                "Karva Chauth Collections: Spousal Bonding Rituals",
                "Gudi Padwa Gear: Maharashtrian New Year Celebrations",
                "Chhath Puja Preparations: Sun God Worship Traditions",
                "Bonalu Basics: Telangana's Goddess Mahakali Festival",
              ]}
              setActive={setActiveMenu}
              activeItem={activeMenu}
            />
            ...
            <div className="md:flex hidden gap-3">
              ...
              {status === "authenticated" && (
                <>
                  ...
                  <div>
                    <p className="text-gray-500 mt-3 uppercase">
                      {session.user?.name}
                    </p>
                  </div>
                </>
